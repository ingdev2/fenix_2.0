...
const AdverseEventContent: React.FC = () => {
  ...
  const [descriptionAdverseEvent, setDescriptionAdverseEvent] = useState("");
            ...
            <Row gutter={[16, 16]} style={{ width: "100%" }}>
              <Col xs={24} sm={25} md={12} lg={12}>
                ...
                >
                  <TextArea
                    rows={4}
                    onChange={(e) => setDescriptionAdverseEvent(e.target.value)}
                    value={descriptionAdverseEvent}
                    style={{ width: "100%" }}
                  />
                </Form.Item>
              </Col>
