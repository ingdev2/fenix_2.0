...
const IncidentContent: React.FC = () => {
  ...
  const allMedicinesData = [
    { id: 1, code: "MC0001", name: "Paracetamol", description: "" },
    { id: 2, code: "MC0002", name: "Morfina", description: "" },
    { id: 3, code: "MC0003", name: "Tiamina", description: "" },
    { id: 4, code: "MC0004", name: "Nivolumap", description: "" },
  ];

  const handleSelectMedicineChange = (value: number) => {
    const selectedMedicine = allMedicinesData.find((med) => med.id === value);

    if (
      selectedMedicine &&
      !selectedMedicines.some((med) => med.id === selectedMedicine.id)
    ) {
            ...
            <Row gutter={[16, 16]} style={{ width: "100%" }}>
              <Col xs={24} sm={25} md={12} lg={12}>
                ...
                >
                  <TextArea
                    rows={4}
                    onChange={(e) => setDescriptionIncident(e.target.value)}
